        ...
        >
          <div className="d-flex align-items-center">
            ...
            <div className={"ps-3"}>
              ...
              {new Date(assignment.dueDate).getUTCMonth() + 1}/
              {new Date(assignment.dueDate).getUTCDay() + 1} at{" "}
              {new Date(assignment.dueDate).getUTCHours()}:
              {new Date(assignment.dueDate).getUTCMinutes()}pm | 100 pts
            </div>
